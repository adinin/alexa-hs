...
HistoryBuffSkill.prototype.intentHandlers = {
    ...
    "DescribeEventIntent": function(intent, session, response){
        var speechText = "Could you describe the seizure?";
        var repromptText = "What did you experience?";
        var speechOutput = {
            speech: speechText,
    ...
    "TriggerEventIntent": function(intent, session, response){
        var speechText = "Do you know what triggered the seizure?";
        var repromptText = "What did you experience?";
        var speechOutput = {
            speech: speechText,
            type: AlexaSkill.speechOutputType.PLAIN_TEXT
    ...
    "LastEventIntent": function(intent, session, response){
        var speechText = "Ok, I have added the seizure to your story line. You can check the Health Story lines app. Hope you have a good day and feel better";
        var speechOutput = {
            speech: speechText,
            type: AlexaSkill.speechOutputType.PLAIN_TEXT
        };
